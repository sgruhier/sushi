...
(function(/*! Stitch !*/) {
  ...
  var MainController, RestaurantView;
  window.app = {};
  app.controllers = {};
  app.models = {};
  app.collections = {};
  ...
  $(document).ready(function() {
    app.initialize = function() {
      ...
      return app.views.home = new RestaurantView();
    };
    app.initialize();
    Backbone.history.start();
    return new iScroll('plates');
  });
  ...
  exports.PlateView = (function() {
    ...
    PlateView.prototype.tag = 'div';
    PlateView.prototype.className = 'plate';
    ...
    PlateView.prototype.increment = function() {
      ...
      return $(this.el).hide().show();
    };
    return PlateView;
  })();
}).call(this);
}, "views/restaurant_view": function(exports, require, module) {(function() {
  var PlateView, Restaurant, restaurantTemplate;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.RestaurantView = (function() {
    ...
    RestaurantView.prototype.className = 'current';
    ...
    RestaurantView.prototype.initialize = function() {
      ...
      this.restaurant.bind('change', this.updateCount);
      return this;
    };
    RestaurantView.prototype.render = function() {
      ...
      $plates = this.$("#plates");
      this.restaurant.each(function(plate) {
        var view;
        view = new PlateView({
          model: plate
        });
    ...
    RestaurantView.prototype.reset = function() {
      if (confirm("Are you sure to reset, total will be set to 0")) {
        return this.restaurant.invoke('set', {
          count: 0
        });
      }
    };
    RestaurantView.prototype.updateCount = function() {
      var info;
      info = _.reduce(this.restaurant.models, function(info, plate) {
      ...
      return $('#total em').html(info.price);
    };
